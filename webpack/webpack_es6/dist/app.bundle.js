...
var asyncFn = exports.asyncFn = function () {
...
var asyncValueFn = exports.asyncValueFn = function () {
    var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        return _context2.abrupt('return', 44);
...
function promiseFn() {
    var mode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'promise';
...
var _otherService = __webpack_require__(61);
...
var _defaultExpression = __webpack_require__(125);

var _defaultExpression2 = _interopRequireDefault(_defaultExpression);

var _ngimport = __webpack_require__(89);

var _ehImport = __webpack_require__(126);
...
otherService.asyncFn().then(function (x) {
    return console.log('other service asyncFn x:', x);
});
otherService.asyncValueFn().then(function (x) {
    return console.log('other service asyncValueFn x:', x);
});
otherService.promiseFn().then(function (x) {
    return x * 2;
}).then(function (x) {
    return console.log('other service promiseFn x:', x);
});
line();
...
console.log('lodash:', _lodash2.default.VERSION);
line();

console.log('jquery:', _jquery2.default.fn.jquery);
line();

console.log('defaultExpression:', _defaultExpression2.default);
line();

console.log('$http:', _ngimport.$http);
console.log('$q:', _ngimport.$q);
line();

console.log('$http2:', _ehImport.$http);
console.log('$q2:', _ehImport.$q);
console.log('$state:', _ehImport.$state);
console.log('$stateParams:', _ehImport.$stateParams);
line();

// import { findIndex } from './util';
// findIndex([4, 8, 4, 8]);

(0, _util.myFindIndex)([4, 8, 4, 8]);
line();
...
var angular = { module: function module() {
    return { component: function component() {
        return { name: 'DefaultExpressionsComponent' };
      } };
  } };

exports.default = angular.module().component().name;
...
Object.keys(_ngimport).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _ngimport[key];
    }
  });
});
var $state = exports.$state = '$STATE';
var $stateParams = exports.$stateParams = '$STATEPARAMS';

exports.$state = $state = '$STATE';
exports.$stateParams = $stateParams = '$STATEPARAMS';
...
exports.myFindIndex = myFindIndex;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(48), __webpack_require__(313)))
